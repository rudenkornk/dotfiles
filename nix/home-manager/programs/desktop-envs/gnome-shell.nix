{ pkgs, ... }:
{
  programs.gnome-shell = {
    ...
    # A bit quirky shortcuts customization, see https://github.com/NixOS/nixpkgs/issues/314969
    # Mark: 👍
    # {
    ...
    # However, at the end of the day, all tiling gnome extensions are laggy and inconsistent.
    # Vanilla gnome just feels smoother.

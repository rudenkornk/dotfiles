  ...
  flake = {
    meta.hosts.dellxps = {
      ...
      monitors = {
        ...
        noctalia = import ./_dellxps/noctalia_monitors.nix;
      };
      gpu = {
        offloadVars = {
    ...
    modules.nixos.host-dellxps =
...

      {
        ...
        local.host = flakeCfg.flake.meta.hosts.dellxps;
    ...
    nixosConfigurations.dellxps = withSystem "x86_64-linux" (
      { pkgs, ... }:
      inputs.nixpkgs.lib.nixosSystem {
        system = "x86_64-linux";
        inherit pkgs;
        modules = [
          flakeCfg.flake.modules.nixos.base
          flakeCfg.flake.modules.nixos.host-dellxps
        ];
      }
    );
  };

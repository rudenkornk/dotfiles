return {
  ...
  { "folke/tokyonight.nvim", opts = { style = "night" } }, -- Styles: moon, storm, night, day.
  { "maxmx03/FluoroMachine.nvim", opts = { glow = true, theme = "fluoromachine" } }, -- Styles: fluoromachine, retrowave, delta.
